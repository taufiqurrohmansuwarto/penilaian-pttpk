/*
  ...
  - You are about to drop the column `deskripsi_pekerjaan` on the `kinerja_bulanan` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "kinerja_bulanan" DROP COLUMN "deskripsi_pekerjaan",
DROP COLUMN "tgl_mulai_pekerjaan",
